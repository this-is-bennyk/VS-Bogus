...
class Paths
{
	...
	static public function soundWithExtension(key:String, extension:String, ?library:String)
		{
	...
	inline static public function musicWithExtension(key:String, extension:String, ?library:String)
		{
	...
	inline static public function voicesWithExtension(song:String, extension:String)
		{
			var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
				switch (songLowercase) {
					case 'dad-battle': songLowercase = 'dadbattle';
			...
			return 'songs:assets/songs/${songLowercase}/Voices.$extension';
		}
	...
	inline static public function instWithExtension(song:String, extension:String)
		{
			var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
				switch (songLowercase) {
					case 'dad-battle': songLowercase = 'dadbattle';
			...
			return 'songs:assets/songs/${songLowercase}/Inst.$extension';
		}
