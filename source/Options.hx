...
class RedditNotesOption extends Option
{
	...
	{
		FlxG.save.data.redditNotes = !FlxG.save.data.redditNotes;
	...
	{
		return  FlxG.save.data.redditNotes ? "Reddit Notes On" : "Reddit Notes Off";
	}
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.redditNotes = null;
