...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			// stop milking my models youtube kids channels - cally
			case 'bogus':
				frames = Paths.getSparrowAtlas('characters/Bogus');
				...
				// else
				if (PlayState.SONG.song == 'Uprising' || PlayState.SONG.song == 'Roses')
					animation.addByPrefix('idle', "Bogus Bogus angry", 12);
				else
					animation.addByPrefix('idle', "Bogus Bogus idle", 12);
				...
				animation.addByIndices('singUP_Loop', "Bogus Bogus up", [1, 3], "", 24);
				animation.addByIndices('singRIGHT_Loop', "Bogus Bogus right", [1, 3], "", 24);
				animation.addByIndices('singLEFT_Loop', "Bogus Bogus left", [1, 3], "", 24);
				animation.addByIndices('singDOWN_Loop', "Bogus Bogus down", [1, 3], "", 24);
				...
				addOffset("singUP_Loop", 0, 0);
				addOffset("singRIGHT_Loop", 0, 0);
				addOffset("singLEFT_Loop", 0, 0);
				addOffset("singDOWN_Loop", 0, 0);
			...
			case 'bogus-elite':
				frames = Paths.getSparrowAtlas('characters/BogusElite');
				// animation.addByPrefix('idle', "BogusElite idle", 12);
				animation.addByPrefix('idle', "BogusElite idle", 19, false);
				animation.addByPrefix('singUP', "BogusElite up", 24, false);
				animation.addByPrefix('singRIGHT', "BogusElite right", 24, false);
				animation.addByPrefix('singLEFT', "BogusElite left", 24, false);
				animation.addByPrefix('singDOWN', "BogusElite down", 24, false);
				
				animation.addByIndices('singUP_Loop', "BogusElite up", [1, 3], "", 24);
				animation.addByIndices('singRIGHT_Loop', "BogusElite right", [1, 3], "", 24);
				animation.addByIndices('singLEFT_Loop', "BogusElite left", [1, 3], "", 24);
				animation.addByIndices('singDOWN_Loop', "BogusElite down", [1, 3], "", 24);
